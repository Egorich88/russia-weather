...
**ДИАГРАММА ТЕХНОЛОГИЧЕСКИЙ СТЕК (с акцентом на технологии)**
...
**Инфраструктура:**
VirtualBox, Vagrant, Ubuntu 22.04, 3 VM

**CI/CD:**
Jenkins, Jenkins Pipeline, Poll SCM, Groovy

**Контейнеризация:**
Docker, Docker Engine, контейнеры, Python 3.9, prometheus_client, requests

**Мониторинг:**
Prometheus, Grafana, HTTPS, самоподписанные сертификаты

**Источник данных:**
Gismeteo API v4, токен доступа

**Безопасность:**
Jenkins Credentials, SSH-ключи, переменные окружения

**Автоматизация:**
Ansible, плейбуки

**Языки и инструменты:**
Python, Groovy, Bash, Git, YAML

Эта диаграмма наглядно показывает все компоненты проекта и их взаимосвязи.
