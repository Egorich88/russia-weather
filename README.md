...
*   **Источник данных:** Экспортер на Python, запущенный в Docker на хосте. Использует **публичное API Gismeteo (v2)** без токена для получения реальных погодных данных.
...
*   **Документация:** README обновлён, все ключевые моменты зафиксированы.
...
*   **Prometheus** также доступен по HTTPS с валидным сертификатом (настроено ранее).
*   **Grafana** уже работала по HTTPS.
* 
...
### 🔮 Планы по развитию
*   [x] Подключение к реальному API погоды (GisMeteo).
