...
if __name__ == "__main__":
    print("Запуск Weather Exporter (расширенная версия, ~150 городов)")
    print(f"Лимит: 1000 запросов/месяц → интервал обновления 5 дней")
    start_http_server(8000)
    while True:
        update_metrics()
        print("--- Цикл обновления завершён. Следующий через 5 дней ---")
        time.sleep(432000)  # 5 дней = 432000 секунд